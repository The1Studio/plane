...
| -------------------------------------------------------------------------------- | -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| `APP_DOMAIN`                                                                     | `plane-staging.the1studio.org`         | The new tunnel hostname                                                                                                                               |
| `WEB_URL`                                                                        | `https://plane-staging.the1studio.org` | Auth callbacks and absolute links                                                                                                                     |
| `CORS_ALLOWED_ORIGINS`                                                           | `https://plane-staging.the1studio.org` | Must not list the production origin                                                                                                                   |
...
| `LISTEN_HTTP_PORT`                                                               | `81`                                   | Verified free on `server`                                                                                                                             |

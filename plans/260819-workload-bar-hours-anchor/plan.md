...
| ------------------------------------------------------------------------------------------------------------ | ---------- | ------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The 60px floor distorts duration at Quarter zoom                                                             | 4          | 2      | 8     | `dayWidth` is 180 (Week) / 60 (Month) / 15 (Quarter), and a bar is at minimum one full day, so the floor binds **only** at Quarter zoom — where a 1–3 day task is drawn up to ~4 days wide. Accepted deliberately: at that zoom the chart is read for load, not duration. Week and Month are untouched. |

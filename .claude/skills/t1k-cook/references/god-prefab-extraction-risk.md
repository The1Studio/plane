...
- `t1k-unity-base-addressables` skill (in theonekit-unity) — Addressable group registration patterns; Lite/Heavy MonoBehaviour singleton pattern
- `t1k-unity-base-game-patterns` skill (in theonekit-unity) — prefab serialization, scene references

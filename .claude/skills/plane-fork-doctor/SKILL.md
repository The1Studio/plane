...
| 3   | **Migration check**          | `cd apps/api && python manage.py makemigrations --check --dry-run` (mirrors CI gate in `master-ci.yml`)                                                                                                                                                | —                                                          | Non-zero exit / pending migrations detected |

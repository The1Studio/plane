...
- `references/session-lifecycle.md` — full session start/end lifecycle (native tiers, feature-flag checks, hook gateway)
- `references/execution-context.md` — how execution context (global/project/hybrid) is detected from `t1k-config-*.json`
- `references/skill-domain-routing.md` — intent-based (natural-language) skill discovery, complementing keyword activation
...
| `/t1k:team` | Parallel agent teams (research/cook/review/debug/triage templates) |
...
|---------------|----------------|
| `t1k:plan` | `t1k:cook`, `t1k:team` |
| `t1k:cook` | `t1k:test`, `t1k:review`, `t1k:team` |

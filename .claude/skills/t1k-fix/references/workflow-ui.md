...
Analyze screenshots/videos with `t1k:extended-multimodal` skill.
...
Screenshot + `t1k:extended-multimodal` analysis.
...
## Tips
- Use `t1k:extended-multimodal` for generating visual assets

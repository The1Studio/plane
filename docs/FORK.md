...
| `.../workspace-views/header.tsx`                                                                                                                                                  | Mounts `WorkItemSearchInput` in `Header.RightItem` before the layout switcher; 300 ms lodash debounce into `fetchIssuesWithExistingPagination(..., "mutation")`                                                                                                                                                                                                   | The header has no plugin slot for an additional toolbar control                                                                                                                                                                                                                                                                                                                                                                                                                                      |
